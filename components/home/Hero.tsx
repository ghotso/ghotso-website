...
import RotatingGlow from '../animations/RotatingGlow';
        ...
        <div className="text-center">
          ...
          <FadeIn delay={0.2} direction="up">
            <div className="mb-8 flex justify-center">
              <RotatingGlow size={150} speed={15} color="both">
          ...
          <FadeIn delay={1} direction="up">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <MagneticButton strength={0.4}>
                <Link
                  href="/projects"
                  className="group inline-flex items-center justify-center px-8 py-3 bg-ghotso-primary text-ghotso-bg font-semibold rounded-xl hover:shadow-glow-primary active:scale-95 transition-all duration-200 relative overflow-hidden"
                >
